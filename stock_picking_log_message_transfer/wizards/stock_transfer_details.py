...
class StockTransferDetails(models.TransientModel):
    ...
    def do_detailed_transfer(self):
        ...
        for transfer_detail in self:
            message = _("Picking transfered")
            partner_ids = [fid.id for fid in transfer_detail.picking_id.message_follower_ids]
            transfer_detail.picking_id.message_post(body=message, partner_ids=partner_ids)
