...
class purchase_order(osv.osv):
    ...
    _columns = {
        'amount_untaxed': fields.function(_amount_all_original, digits_compute=dp.get_precision('Account'), string=_('Subtotal'),
            store={
        ...
        'amount_untaxed_original': fields.function(_amount_all_original, digits_compute=dp.get_precision('Account'), string=_('Subtotal (Original)'),
            store={
                'purchase.order.line': (_get_order, None, 10),
            }, multi="sums"),
